...
phy_layer_funcs_t si446x_phy_funcs;
...
void vRadio_StartRX(U8 packetLenght)
{
  ...
  si446x_start_rx(0, 0u, packetLenght,
...
state vMessageSent(){
 if(bRadio_Check_Tx_RX() == SI446X_CMD_GET_INT_STATUS_REP_PH_PEND_PACKET_SENT_PEND_BIT){
     return OK;
 }else{
     return ERROR;
 }
